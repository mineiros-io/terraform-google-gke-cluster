...
variable "enable_autopilot" {
  type        = bool
  description = "(Optional) Enable Autopilot for this cluster. Note that when this option is enabled, certain features of Standard GKE are not available. For details please see https://cloud.google.com/kubernetes-engine/docs/concepts/autopilot-overview#comparison"
  default     = false
}
